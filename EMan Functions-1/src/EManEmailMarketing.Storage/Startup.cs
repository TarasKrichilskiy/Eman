...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddScoped<IEmailQueueRepository>(_ => new EmailQueueRepository(new QueueClient(Configuration.GetConnectionString("QueueConnection"), QueueConstants.EmailQueue)));
    }
